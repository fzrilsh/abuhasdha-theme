...
<section style="background-image: url('<?= $background ?>');" class="w-full flex flex-col md:flex-row gap-6 md:gap-18 justify-center items-center md:items-start pt-26 pb-24 bg-orange">
